# Ομάδα 3 - Ηλεκτρονική κράτηση αεροπορικών εισιτηρίων
...
* Προβολή Στατιστικών Στοιχείων για την κάθε αεροπορική σχετικά με τις πτήσεις της (μέση πληρότητα των αεροπλάνων, μηνιαία έσοδα, δημοφιλείς προορισμοί)
...
Μελετώντας την εφαρμογή εντοπίζουμε τρεις διακριτούς <span style="color:blueviolet; font-weight:bold;">actors</span>. Παρακάτω αναφέρονται οι απαιτήσεις του καθένα:
 ...
 Ο **διαχειριστής** του συστήματος χαρακτηρίζεται από *username*, *password* και *id*.
...
* Η κάθε **αεροπορική** χαρακτηρίζεται από την *ονομασία* της, τα *αεροδρόμια που εξυπηρετεί*, τον *2-digit κωδικό* της, *username*, *password* και *admin id*.
* Η **αεροπορική** μπορεί να επεξεργαστεί και να ανανεώσει τα *αεροδρόμια που εξυπηρετεί* καθώς και το *password* της.
...
* Το username και το id της αεροπορικής και του χρήστη είναι μοναδικά.
...
* Η κράτηση και χρέωση αφορά τη συνολική διαδρομή (με επιστροφή ή χωρίς). Όταν δημιουργείται μια κράτηση υπολογίζεται το συνολικό κόστος των εισιτηρίων ανάλογα τον αριθμό των πτήσεων, τον αριθμό των επιβατών, και τον τύπο του εισιτηρίου (με ή χωρίς αποσκευή) ενώ παράλληλα μειώνονται οι διαθέσιμες θέσεις για την κάθε πτήση.
