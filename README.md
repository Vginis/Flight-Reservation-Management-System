...
* Προβολή Στατιστικών Στοιχείων για την κάθε αεροπορική σχετικά με τις πτήσεις της (<u>μέση πληρότητα όλων των πτήσεων, μέση πληρότητα κάθε πτήσης,<u>δημοφιλές αεροδρόμιο</u>)
...
* Η **αεροπορική** μπορεί να λαμβάνει *στατιστικά στοιχεία* για τις πτήσεις της όπως <u>μέση πληρότητα όλων των πτήσεων, μέση πληρότητα κάθε πτήσης, δημοφιλές αεροδρόμιο</u>. <-ΙΔΙΟ ΜΕ ΠΑΝΩ
