...
* Προβολή Στατιστικών Στοιχείων για την κάθε αεροπορική σχετικά με τις πτήσεις της (<u>μέση πληρότητα όλων των πτήσεων, μέση πληρότητα κάθε πτήσης,</u> {μηνιαία έσοδα,} <u>δημοφιλές αεροδρόμιο</u>)
...
* Ο **διαχειριστής** του συστήματος χαρακτηρίζεται από *username*, *password*<u> και *admin_id*</u>.
...
* Η κάθε **αεροπορική** χαρακτηρίζεται από την *ονομασία* της, τον *2-digit κωδικό* της, *username*, *password*<u> και μια *λίστα με τις πτήσεις της*</u>.
...
* Η **αεροπορική** μπορεί να λαμβάνει *στατιστικά στοιχεία* για τις πτήσεις της όπως <u>μέση πληρότητα όλων των πτήσεων, μέση πληρότητα κάθε πτήσης, μηνιαία έσοδα, δημοφιλές αεροδρόμιο</u>. <-ΙΔΙΟ ΜΕ ΠΑΝΩ
* Η κάθε πτήση χαρακτηρίζεται από *κόστος απλού εισιτηρίου*, *αεροδρόμιο αναχώρησης*, *<u>ημερομηνία & </u>ώρα αναχώρησης*, *<u>ημερομηνία & </u>ώρα άφιξης*, *αεροδρόμιο άφιξης*, *χωρητικότητα αεροσκάφους*, *τύπος αεροσκάφους*, *αεροπορική εταιρεία*, *αριθμό διαθέσιμων θέσεων*<u>, μια *λίστα με τα εισιτήρια*</u> και μοναδικό *κωδικό πτήσης*.
* Ο κάθε **χρήστης** του συστήματος χαρακτηρίζεται από *username*, *password*, *email*, *αριθμό τηλεφώνου*<u>, μια *λίστα με τις κρατήσεις*</u> και *αριθμό διαβατηρίου/ταυτότητας*.
...
* Για την συγγραφή του κώδικα χρησιμοποιείται το {Eclipse IDE 2023-09}<u>IntelliJ IDEA</u>.
