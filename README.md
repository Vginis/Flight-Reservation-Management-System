...
* Ο **διαχειριστής** του συστήματος χαρακτηρίζεται από *username*, *password* και *admin_id* και 3 λίστες που αφορούν τους επιβάτες,αεροπορικές εταιρείες και αεροδρόμια.
* Ο **διαχειριστής** του συστήματος έχει τη δυνατότητα να προοσθέσει/διαγράψει στοιχεία των αεροδρομίων,επιβατών,αεροπορικών εταιρειών στο σύστημα. Σε περίπτωση που τα στοιχεία υπάρχουν ήδη στο σύστημα εμφανίζεται αντίστοιχο μήνυμα.
